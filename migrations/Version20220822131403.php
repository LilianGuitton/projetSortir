 ...
 */
final class Version20220822131403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD est_rattacher_a_id INT NOT NULL');
        $this->addSql('ALTER TABLE participant ADD CONSTRAINT FK_D79F6B1154E9B602 FOREIGN KEY (est_rattacher_a_id) REFERENCES campus (id)');
        $this->addSql('CREATE INDEX IDX_D79F6B1154E9B602 ON participant (est_rattacher_a_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP FOREIGN KEY FK_D79F6B1154E9B602');
        $this->addSql('DROP INDEX IDX_D79F6B1154E9B602 ON participant');
        $this->addSql('ALTER TABLE participant DROP est_rattacher_a_id');
